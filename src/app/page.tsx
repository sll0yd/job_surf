    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          <svg
            className="animate-spin h-12 w-12 mx-auto text-indigo-500"
    ...
    return (
      <div className="bg-gradient-to-b from-blue-50 to-blue-100">
        ...
        <div className="relative overflow-hidden">
          <div className="absolute inset-y-0 w-full h-full">
            ...
            >
              <path
                fill="currentColor"
                fillOpacity="1"
                d="M0,192L48,170.7C96,149,192,107,288,122.7C384,139,480,213,576,218.7C672,224,768,160,864,144C960,128,1056,160,1152,170.7C1248,181,1344,171,1392,165.3L1440,160L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"
              ></path>
            </svg>
          </div>
          ...
          <div className="relative mt-10 px-4 sm:px-6 lg:mt-16 lg:px-20">
            {" "}
              ...
              <div className="lg:grid lg:grid-cols-12 lg:gap-8">
                <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
                  ...
                  <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                    Navigate the job search ocean with confidence. Track
                    applications, manage interviews, and catch the perfect
                    opportunity with JobSurf&apos;s intuitive dashboard.
                  </p>
        ...
        >
          <div className="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
            ...
            <p className="mt-5 max-w-prose mx-auto text-xl text-gray-500">
              Everything you need to catch the perfect opportunity and land your
              dream job
            </p>
            <div className="mt-12">
                  ...
                  <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                    <div className="-mt-6">
                      ...
                      <p className="mt-5 text-base text-gray-500">
                        Track all your applications in one place with our
                        intuitive dashboard. Never lose track of where you stand
                        with each company.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                    <div className="-mt-6">
                      ...
                      <p className="mt-5 text-base text-gray-500">
                        ...
                        timeline view. Never miss an interview or follow-up
                        again.
                      </p>
                    </div>
                  </div>
                ...
                <div className="pt-6">
                  <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                    <div className="-mt-6">
                      ...
                      <p className="mt-5 text-base text-gray-500">
                        Record all interactions with each company. Keep notes
                        from calls, emails, and interviews for reference.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="pt-6">
                  <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                    <div className="-mt-6">
                      ...
                      <p className="mt-5 text-base text-gray-500">
                        Get notified about upcoming deadlines, interview dates,
                        and when it&apos;s time to follow up with a company.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                    <div className="-mt-6">
                      ...
                      <p className="mt-5 text-base text-gray-500">
                        ...
                        progress, application success rate, and more.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="pt-6">
                  <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                    <div className="-mt-6">
                      ...
                      <p className="mt-5 text-base text-gray-500">
                        Keep track of your professional network, references, and
        ...
        <div
          id="testimonials"
          className="bg-gradient-to-r from-indigo-50 to-blue-50 py-16 sm:py-24"
        >
                ...
                <div className="h-full flex flex-col justify-between">
                  <div>
                    ...
                    <div className="mt-4 text-gray-600">
                      <p>
                        &quot;JobSurf helped me organize my job search and land
                        3 interviews in the first week. The dashboard is
                        intuitive and keeps me on track with follow-ups.&quot;
                      </p>
                    </div>
                  </div>
              ...
              <div className="p-6 bg-white rounded-lg shadow-lg">
                <div className="h-full flex flex-col justify-between">
                  <div>
                    ...
                    <div className="mt-4 text-gray-600">
                      <p>
                        &quot;I was applying to dozens of jobs and losing track
                        of everything. JobSurf helped me stay organized and
                        professional. I secured my dream job within a
                        month!&quot;
                      </p>
                    </div>
                  </div>
              ...
              <div className="p-6 bg-white rounded-lg shadow-lg">
                <div className="h-full flex flex-col justify-between">
                  <div>
                    ...
                    <div className="mt-4 text-gray-600">
                      <p>
                        &quot;The analytics feature showed me which job boards
                        were most effective for my industry. JobSurf helped me
                        work smarter, not harder in my search.&quot;
                      </p>
                    </div>
                  </div>
                  <div className="mt-6 flex items-center">
        ...
        <div id="faq" className="bg-white">
          <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
            <h2 className="text-base font-semibold tracking-wider text-indigo-600 uppercase text-center">
              FAQ
            </h2>
              ...
              <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-12 lg:grid-cols-2">
                <div>
                  ...
                  <dd className="mt-2 text-base text-gray-500">
                    ...
                    encryption and security practices to ensure your personal
                    information and job application details remain private and
                    protected.
                  </dd>
                </div>
                <div>
                  ...
                  <dd className="mt-2 text-base text-gray-500">
                    Yes! JobSurf includes a powerful reminder system that can
                    notify you about upcoming interviews, application deadlines,
                    and when it&apos;s time to follow up with a company.
                  </dd>
                </div>
                <div>
                  ...
                  <dd className="mt-2 text-base text-gray-500">
                    Just click the &quot;Sign up free&quot; button to create
                    your account. You&apos;ll be tracking your job applications
